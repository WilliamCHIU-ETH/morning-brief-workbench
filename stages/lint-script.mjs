...
const CTA = [
  ...
  // acceptance.json 的 rule 自己寫「推薦頁籤、開啟 App 之類」，但清單裡沒有
  // 任何一條會匹配「開啟 App」。紅隊寫「打開 App，到主力買賣超那一頁」就通過。
  { re: /(開啟|打開|下載|點開)\s*(籌碼\s*K\s*線|App|APP|應用程式)/, label: '口播 CTA：叫觀眾開 App' },
  { re: /(那一頁|這一頁|該頁面|頁面裡)/, label: '口播 CTA：指涉 App 頁面' },
  { re: /主力(買賣超|動向|進出)那?一?[頁籤]/, label: '口播 CTA：指涉籌碼頁' },
];
